...
struct TimeTravelerGameView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            gameState.loadScenario(.discovery)
            currentText = gameState.storyText
        }
    }
...
extension TimeTravelerGameState {
    var isFirstScene: Bool {
        currentScenario == .discovery
    }
}

struct TimeTravelerGameView_Previews: PreviewProvider {
    static var previews: some View {
        TimeTravelerGameView(settings: SettingsModel())
    }
} 
