...
struct DragonsQuestGameView: View {
    @ObservedObject var settings: SettingsModel
    @StateObject private var gameState = DragonsQuestGameState()
    @Environment(\.dismiss) var dismiss
    
    @State private var selectedChoice: Int? = nil
    @State private var currentText: String = ""
    @State private var showingConsequence = false
    @State private var previousScenarios: [DQScenario] = []
    ...
    var body: some View {
        ...
        .onAppear {
            gameState.loadScenario(.dragonAwakening)
            currentText = gameState.storyText
        }
    }
    
    private func navigateToNext(choice: DQChoice) {
...
extension DragonsQuestGameState {
    var isFirstScene: Bool {
        currentScenario == .dragonAwakening
    }
}

struct DragonsQuestGameView_Previews: PreviewProvider {
    static var previews: some View {
        DragonsQuestGameView(settings: SettingsModel())
    }
} 
