...
struct LostCityGameView: View {
    @StateObject private var gameState = LostCityGameState()
    ...
    var body: some View {
        ...
        .onAppear {
            // Load initial scenario for Lost City game
            gameState.loadScenario(.awakening)
        }
    }
}

struct LostCityGameView_Previews: PreviewProvider {
